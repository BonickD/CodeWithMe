...
{
    [Info("MenuRevolve", "Mercury", "0.0.2")]
    ...
    class MenuRevolve : RustPlugin
    {
        ...
        void SelectCategory(BasePlayer player,int CategoryIndex,int Page)
        {
            ...
            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0.1875 0.0240741", AnchorMax = "0.9875 0.82037566" },
                Image = { Color = "0 0 0 0.5" }
            ...
            if (CountText > (Page + 1) * 20)
            {
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.8802084 0", AnchorMax = "1 0.08" },
